package com.halfeaten.vaycray.firebase
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        val REPLY_ACTION = "com.halfeaten.vaycray.firebase.REPLY_ACTION"
    ...
    private fun setupChannels(
        ...
        notification.setSmallIcon(R.drawable.ic_rocket_white)
