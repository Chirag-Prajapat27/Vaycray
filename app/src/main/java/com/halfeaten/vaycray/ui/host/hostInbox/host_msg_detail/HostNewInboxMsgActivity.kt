...
import com.halfeaten.vaycray.databinding.HostActivityInboxMessagesBinding
    ...
    fun getPreApproved(threadItems: GetThreadsQuery.ThreadItemForType) {
        ...
        if (viewModel.preApproved.value?.id != 0) {
            ...
            if (viewModel.preApproved.value!!.type.equals("requestToBook")) {
                ...
                setRequestSent()
            } else if (viewModel.preApproved.value!!.type.equals("approved") || viewModel.preApproved.value!!.type.equals(
                    "instantBooking"
                )
            ) {
                setCancelBooking()
