package com.halfeaten.vaycray.ui.inbox.msg_detail
...
import com.halfeaten.vaycray.ViewListingDetailsQuery
import com.halfeaten.vaycray.databinding.ActivityInboxMessagesBinding
...
import com.halfeaten.vaycray.ui.inbox.InboxNavigator
...
import com.halfeaten.vaycray.vo.PreApproved
...
class NewInboxMsgActivity : BaseActivity<ActivityInboxMessagesBinding, InboxMsgViewModel>(), InboxNavigator {
    ...
    fun getPreApproved(threadItems: @Nullable GetThreadsQuery.ThreadItemForType) {
        ...
        if(viewModel.preApproved.value?.id != 0){
            ...
            if(viewModel.preApproved.value!!.type.equals("approved") || viewModel.preApproved.value!!.type.equals("instantBooking")){
                setCancelBooking()
