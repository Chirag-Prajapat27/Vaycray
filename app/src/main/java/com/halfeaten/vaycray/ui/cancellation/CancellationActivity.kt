...
import com.halfeaten.vaycray.CancellationDataQuery
import com.halfeaten.vaycray.R
import com.halfeaten.vaycray.databinding.FragmentCancellationBinding
    ...
    private fun setDetails(details: CancellationDataQuery.Results) {
        ...
        try {
            with(mBinding) {
                ...
                this.desc = getString(R.string.cancellation_policy_title_part1)

                this.desc2 = getString(R.string.cancellation_policy_title_part2)+" "
                ...
                if (userType.equals("host")) {
                    ...
                    val currency = viewModel?.getCurrencySymbol() + " " + Utils.formatDecimal(details.isSpecialPriceAverage!!.toDouble())
