...
import com.halfeaten.vaycray.databinding.ActivityListingDetailsEpoxyBinding
...
import com.halfeaten.vaycray.ui.listing.share.ShareActivity
...
import com.halfeaten.vaycray.util.Utils.Companion.clickWithDebounce
...
class ListingDetails : BaseActivity<ActivityListingDetailsEpoxyBinding, ListingDetailsViewModel>(),
    ...
    private fun generateMapLocation(latitude: Double, longitude: Double): String {
        ...
        return GoogleStaticMapsAPIServices.getStaticMapURL(this@ListingDetails,location, 155)
    }
...
//                    intent.putExtra("userData", viewModel.userData.value!!)
