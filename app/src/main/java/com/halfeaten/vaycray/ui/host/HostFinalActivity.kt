package com.halfeaten.vaycray.ui.host
...
import com.halfeaten.vaycray.databinding.HostFinalActivityBinding
...
import com.halfeaten.vaycray.viewholderHostFinalPage
import com.halfeaten.vaycray.viewholderHostInitalBelow
import com.halfeaten.vaycray.viewholderSteps
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (intent.getBooleanExtra("isDeep", false)) {
                    startActivity(Intent(this@HostFinalActivity, HostHomeActivity::class.java))
                    finish()
                } else {
                    this@HostFinalActivity.finish()
                }
            }
        })
