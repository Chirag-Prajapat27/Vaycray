...
import com.halfeaten.vaycray.CreateListingMutation
import com.halfeaten.vaycray.GetCountrycodeQuery
import com.halfeaten.vaycray.GetListingSettingQuery
import com.halfeaten.vaycray.GetStep1ListingDetailsQuery
import com.halfeaten.vaycray.ManageListingStepsMutation
...
import com.halfeaten.vaycray.vo.BecomeHostStep1
import com.halfeaten.vaycray.vo.PersonCount
...
class StepOneViewModel @Inject constructor(
    ...
    fun checkValidation() {
        ...
        if (becomeHostStep1.value?.street == street.get() && becomeHostStep1.value?.country == countryCode.get() && becomeHostStep1.value?.state == state.get()) {
            ...
            Log.d("steponview","207")
        } else {
            Log.d("steponview","210")
            address.set(
