...
import com.halfeaten.vaycray.ViewholderTripsListBindingModel_
import com.halfeaten.vaycray.data.remote.paging.NetworkState
import com.halfeaten.vaycray.data.remote.paging.Status
import com.halfeaten.vaycray.databinding.FragmentTripsListBinding
...
class TripsListFragment : BaseFragment<FragmentTripsListBinding, TripsViewModel>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initController()
        mBinding.image.setImageDrawable(ContextCompat.getDrawable(requireContext(),R.drawable.ic_no_result))
        viewModel.let {
            if (param1 == "upcoming") {
        ...
        private fun initiatePopupWindow(
            ...
            try {
                ...
                if (item?.reservationState != null && item.listData != null) {
                    ...
                    if ((item.reservationState == "approved")) {
                ...
                itinerary.setCompoundDrawablesRelativeWithIntrinsicBounds(
                    ContextCompat.getDrawable(requireContext(),R.drawable.ic_task),
                    null,
                    null,
                    null
                )
                receipt.setCompoundDrawablesRelativeWithIntrinsicBounds(
                    ContextCompat.getDrawable(requireContext(),R.drawable.ic_itinerary),
                    null,
                    null,
                    null
                )
